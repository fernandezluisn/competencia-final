...
# OPT BAYESIANA CON 17meses 40 % 50 iteraciones bayesianas
#limpio la memoria
...
PARAM  <- list()
PARAM$experimento <- "HT9410final"

PARAM$exp_input  <- "TS9310final"
...
dataset_input  <- paste0( "./exp/", PARAM$exp_input, "/dataset_training17.csv.gz" )
